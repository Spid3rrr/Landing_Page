      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            At 4A4B, we're on a mission to revolutionize the way people interact with technology. Our cutting-edge products and services combine the latest advancements in AI, machine learning, and data analytics to deliver unparalleled results.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Partnered with over <span className="text-indigo-600">50+</span>{" "}
            companies worldwide
          </div>
